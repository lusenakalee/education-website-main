            ...
            <div className="lg:pr-8 lg:pt-4">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  ...
                  <br />
                  <br />
                  At SERF, our core objectives revolve around intensive policy
                  and economic management research, targeted capacity
                  development across various sectors related to policy and
                  socio-economic matters, and efficient knowledge management.
                  Over a span of seventeen years, we have honed our expertise
                  and established ourselves as a pioneering think tank, delving
                  into the intricacies of policy options and development
                  management challenges.
                  <br />
                  <br />
                  Our commitment to empowering professionals and decision-makers
                  sets us apart. Through comprehensive training programs and
                  knowledge dissemination initiatives, we equip individuals with
                  the insights and skills needed to make informed decisions.
                  ...
                  <br />
                  <br />
                  SERF’s legacy is defined by its unwavering dedication to
                  bridging knowledge gaps. By disseminating valuable insights,
                  we contribute significantly to informed policy discourse and
